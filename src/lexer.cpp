...
Token Lexer::identifier(SourceLocation loc) {
  ...
  static const std::unordered_map<std::string, TokenKind> keywords = {
      ...
      {"latest", TokenKind::Latest},   {"history", TokenKind::History}, {"every", TokenKind::Every},
      {"max_age", TokenKind::MaxAge},  {"state", TokenKind::State},   {"region", TokenKind::Region},
      {"overflow", TokenKind::Overflow}, {"capacity", TokenKind::Capacity},
      {"pipeline", TokenKind::Pipeline}, {"runtime", TokenKind::Runtime}, {"frame", TokenKind::Frame},
      {"measurement", TokenKind::Measurement}, {"contract", TokenKind::Contract},
      {"controller", TokenKind::Controller}, {"mpc", TokenKind::Mpc}, {"cbf", TokenKind::Cbf},
      {"clf", TokenKind::Clf},         {"world_model", TokenKind::WorldModel}, {"source", TokenKind::Source},
      {"effects", TokenKind::Effects}, {"constraint", TokenKind::Constraint},
      {"assume", TokenKind::Assume},   {"guarantee", TokenKind::Guarantee}, {"invariant", TokenKind::Invariant},
      {"on_timeout", TokenKind::OnTimeout}, {"on_stale_state", TokenKind::OnStaleState},
      {"on_infeasible", TokenKind::OnInfeasible},
      {"on", TokenKind::On},           {"event", TokenKind::Event},
